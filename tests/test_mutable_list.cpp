...
int test_mutable_list_main() {
    ...
    //append
    MutableListSequence<int>* seq3 = new MutableListSequence<int>();
    seq3->Append(10);
    seq3->Append(20);
    ...
    //prepend
    MutableListSequence<int>* seq4 = new MutableListSequence<int>();
    seq4->Prepend(10);
    seq4->Prepend(20);
    seq4->Prepend(30);
    ...
    //concat
    MutableListSequence<int>* seq9 = new MutableListSequence<int>(data, 2);
    ...
    MutableListSequence<int>* seq11 = new MutableListSequence<int>();
    ...
    //пустая
    ImmutableListSequence<int>* imm1 = new ImmutableListSequence<int>();
    check(imm1->GetLength() == 0, "immutable пустая: length = 0");
    delete imm1;

    //append
    ImmutableListSequence<int>* imm2 = new ImmutableListSequence<int>();
    imm2->Append(10);
    imm2->Append(20);
    ...
    //prepend
    ImmutableListSequence<int>* imm3 = new ImmutableListSequence<int>();
    imm3->Prepend(10);
    imm3->Prepend(20);
    ...
    //insertAt
    ImmutableListSequence<int>* imm4 = new ImmutableListSequence<int>(data, 3);
    imm4->InsertAt(99, 1);
